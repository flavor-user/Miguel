...
export function SiteAccessForm({
  ...
  return (
    <div className="mx-auto max-w-md pt-16">
      ...
      <p className="mt-4  leading-relaxed">{t.subtitle}</p>

      <form onSubmit={handleSubmit} className="mt-10 space-y-4">
        <div>
          <label htmlFor="access-code" className="mb-1 block  ">
            {t.label}
          </label>
          <input
            id="access-code"
            ...
            required
            className="w-full border-b border-neutral-300 bg-transparent py-3  placeholder:text-neutral-400 focus:border-neutral-900 focus:outline-none"
      ...
      <p className="mt-8 text-xs leading-relaxed">{t.note}</p>
    </div>
  );
}
